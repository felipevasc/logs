...
- Linha do tempo do caso em modos vertical e horizontal: dia abreviado uma vez por seção, horário em cada ocorrência, marcas curtas junto ao eixo, intervalos simultâneos em trilhos separados e agrupamento automático de eventos consecutivos semelhantes. É possível selecionar e agrupar ocorrências, mover nomes para o outro lado, editar título e cor, criar marcos e adicionar notas com ícone ou texto. As curvas das notas podem ter pontas opcionais, traço contínuo, tracejado ou pontilhado, e um ponto arrastável para ajustar o trajeto. Cada extremidade pode ser ligada à esquerda, direita, parte superior ou inferior do título e do conteúdo da nota por seleção ou arraste. As posições das notas e os ajustes das curvas são guardados separadamente para cada modo.
